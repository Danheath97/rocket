...
public class plateMesh : MonoBehaviour {
	...
	public static Vector3 wind = new Vector3(10 ,-7,0); // create a public static on another script and link it to this one
	// Plate dimensions
	[HideInInspector]
	public float chord;
	[HideInInspector]
	...
	float dampConst;
    public static float NForce;
    public static float AForce;
